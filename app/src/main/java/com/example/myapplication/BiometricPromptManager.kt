        ...
        val biometricPrompt = BiometricPrompt(activity, executor, object : BiometricPrompt.AuthenticationCallback() {
            override fun onAuthenticationSucceeded(result: BiometricPrompt.AuthenticationResult) {
                ...
                result.cryptoObject?.cipher?.let { resultCipher ->
                    ...
                    val base64EncrypedData = Base64.encodeToString(encryptedData, Base64.DEFAULT)

                    Log.d(TAG, "AuthenticationResult success base64IV: ${base64IV}")

                    Log.d(TAG, "AuthenticationResult success base64EncrypedData: ${base64EncrypedData}")

                    Log.d(TAG, "AuthenticationResult success iv: ${iv.toString()}")

                    Log.d(TAG, "AuthenticationResult success encryptedData: $encryptedData")

                    Log.d(TAG, "AuthenticationResult success iv Byte: ${iv.toUByteArray()}")

                    Log.d(TAG, "AuthenticationResult success encryptedData Byte: ${encryptedData.toUByteArray()}")
