    ...
    private fun handleDecrypt(
        ...
        val biometricPrompt = BiometricPrompt(activity, executor, object : BiometricPrompt.AuthenticationCallback() {
            override fun onAuthenticationSucceeded(result: BiometricPrompt.AuthenticationResult) {
                ...
                Log.d(TAG, "AuthenticationResult success cryptoObject: " + result.cryptoObject)
                ...
                Log.i(TAG, "AuthenticationResult success Encrypted information: " +
                        Arrays.toString(encryptedInfo))

                val decryptedData = aead.decrypt(getEncryptedData(), EMPTY_ASSOCIATED_DATA)


                Log.i(TAG, "AuthenticationResult success decryptedData: " +
                        Arrays.toString(encryptedInfo))
